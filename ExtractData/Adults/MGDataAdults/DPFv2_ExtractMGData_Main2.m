...
%for DPFv2 data collected by MG- Adults
...
SubjectsStruct.(subjectID).SubjectDataOriginal = SubjDataOriginal;
...
cd /Volumes/purplab/EXPERIMENTS/1_Current_Experiments/Caroline/Caroline2/DPF_V2_(all)/DPFv2Scripts/ExtractDataAdults/MGDataAdults
