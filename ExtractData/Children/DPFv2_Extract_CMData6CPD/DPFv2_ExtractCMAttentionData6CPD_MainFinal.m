...
ChildAdultCategory = 'adolescent';
ChildAdultNumeric = 2;

attentionCond = 'exo'

SubNo = str2num(SubNoString);
AAALastEditDate = '05.12.21'
...
NumTrialsPerLocValidTable = [NumTrialsPerLocValid(1), NaN, NumTrialsPerLocValid(2),NaN,NumTrialsPerLocValid(3),NaN,NumTrialsPerLocValid(4),NaN]
NumTrialsPerLocValidTable = array2table(NumTrialsPerLocValidTable)
NumTrialsPerLocValidTable.Properties.VariableNames = {'N','NE','E','SE','S','SW','W','NW'};
...
NumTrialsPerLocNeutralTable = [NumTrialsPerLocNeutral(1), NaN, NumTrialsPerLocNeutral(2),NaN,NumTrialsPerLocNeutral(3),NaN,NumTrialsPerLocNeutral(4),NaN]
NumTrialsPerLocNeutralTable = array2table(NumTrialsPerLocNeutralTable)
NumTrialsPerLocNeutralTable.Properties.VariableNames = {'N','NE','E','SE','S','SW','W','NW'};

SubjectsStruct.(subjectID).NumTrialsNeutral = NumTrialsPerLocNeutralTable;
SubjectsStruct.(subjectID).NumTrialsValid = NumTrialsPerLocValidTable;
...
AccuracyOverallNeutralUncorrectedWeighted2 = (nansum(weightedNeutralCorrected(:)))/(nansum(WeightsNeutral(:)));
...
SubjectsStruct.AAALastEditDate = AAALastEditDate
SubjectsStruct.(subjectID).attentionCond = attentionCond
SubjectsStruct.(subjectID).numLocsTested = numLocations
% SubjectsStruct.(subjectID).NumTrialsNeutral = NumTrialsPerLocNeutral
% SubjectsStruct.(subjectID).NumTrialsValid = NumTrialsPerLocValid
%% 23 Save
...
cd /Volumes/purplab/EXPERIMENTS/1_Current_Experiments/Caroline/Caroline2/DPF_V2_(all)/DPFv2Scripts/ExtractDataAdults/Children/CMData
