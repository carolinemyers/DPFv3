...
AccuracyOverallValidWeighted = nansum(weightedValidUncorrected)
AccuracyOverallValidCorrectedWeighted = nansum(weightedValidCorrected)
...
AccuracyOverallNeutralWeighted = nansum(weightedNeutralUncorrected)
AccuracyOverallNeutralCorrectedWeighted = nansum(weightedNeutralCorrected)
...
save('SubjectsStruct050421.mat','SubjectsStruct');

%cd /Volumes/purplab/EXPERIMENTS/1_Current_Experiments/Caroline/Caroline2/DPF_V2_(all)/DPFv2Scripts/ExtractDataAdults/Children/MRData